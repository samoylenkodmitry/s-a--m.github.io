...
---
# Как быстрее итерировать массивы
...
Померяем "на глаз" (через SystemClock.elapsedRealtimeNanos) на устройстве OnePlus 3T (Android 8, API 26, Snapdragon 835).
...
Попробуем Megafon Login (Android 4.4.2). Создать массив из 100млн интов на нем не удалось из-за OOM, поэтому только 1млн.
